...
import type { Media, PublicationsBlock } from '@/payload-types'
                ...
                return (
                  <div key={index} className="mb-12 mt-6 space-y-8">
                    {node.fields.items.map(
                      (item: NonNullable<PublicationsBlock['items']>[number], subIndex: number) => (
              ...
              case 'button':
                return (
                  <Link
                    ...
                    rel={node.fields.link.url ? 'noopener noreferrer nofollow' : undefined}
                      ...
                      <div className="flex flex-col">
                        ...
                        {node.fields.author.about && (
                          <div
                            ...
                            dangerouslySetInnerHTML={{
                              __html: escapeHTML(node.fields.author.about).replace(/\n/g, '<br>'),
                            }}
                          />
                        )}
                      </div>
