  ...
  return isClient ? (
    consent || oneTimeConsent ? (
      ...
      <div className="font-italic flex min-h-32 flex-col items-center justify-center bg-gray-100 p-[10%] text-center text-sm">
        <p>
          Dieses Video wird nicht angezeigt, da Sie der Nutzung von Tracking-Cookies nicht
          zugestimmt haben. Sie können hier einmalig ihre Zustimmung geben. Lesen Sie hierzu unsere{' '}
